...
<body class="bg-light">
    <div class="container mt-5">
        <div>
            ...
            <h2 class="text-center">Gestión de grados </h2>
            <p class="text-muted text-center">Aquí puedes gestionar los grados de la institución</p>
