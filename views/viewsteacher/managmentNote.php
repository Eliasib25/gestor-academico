    ...
    <div class="container mt-5"> 
        <div>
            <div class="text-start mt-4">
                <a href="../dashboard/teacher.php" class="btn btn-secondary">Volver al dashboard</a>
            </div>
        <h2 class="text-center">Gestión de notas</h2>
        <p class="text-muted text-center">Aquí puedes gestionar las notas de los estudiantes</p>
